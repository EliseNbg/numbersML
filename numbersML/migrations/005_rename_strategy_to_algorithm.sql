...
ALTER TABLE IF EXISTS strategy_instances RENAME TO strategy_instances;
...
COMMENT ON TABLE strategy_instances IS 'Running instances of algorithms (formerly strategy_instances)';
