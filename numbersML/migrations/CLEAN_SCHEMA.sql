...
--
-- Name: update_config_set_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_config_set_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
--
-- Name: update_strategy_instance_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_strategy_instance_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
--
-- Name: COLUMN candles_1s.predicted_value; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: configuration_sets; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.configuration_sets (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
    name text NOT NULL,
    description text,
...
--
-- Name: TABLE configuration_sets; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.configuration_sets IS 'Reusable configuration parameter sets for strategies';


--
-- Name: COLUMN configuration_sets.name; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.configuration_sets.name IS 'Human-readable name (unique)';


--
-- Name: COLUMN configuration_sets.config; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.configuration_sets.config IS 'JSONB with symbols, thresholds, risk, execution params';


--
-- Name: COLUMN configuration_sets.is_active; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.configuration_sets.is_active IS 'Whether available for new strategy instances';


--
-- Name: COLUMN configuration_sets.version; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.configuration_sets.version IS 'Incremented on each config update';
...
CREATE TABLE public.strategy_instances (
    ...
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone DEFAULT now(),
    CONSTRAINT chk_runtime_stats_json CHECK ((jsonb_typeof(runtime_stats) = 'object'::text)),
    CONSTRAINT strategy_instances_status_check CHECK ((status = ANY (ARRAY['stopped'::text, 'running'::text, 'paused'::text, 'error'::text])))
);
...
COMMENT ON TABLE public.strategy_instances IS 'Running instances of algorithms (formerly algorithm_instances)';


--
-- Name: COLUMN strategy_instances.algorithm_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.strategy_instances.algorithm_id IS 'Renamed from strategy_id';


--
-- Name: COLUMN strategy_instances.runtime_stats; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.strategy_instances.runtime_stats IS 'JSONB with PnL, trades, uptime, etc.';
...
--
-- Name: configuration_sets configuration_sets_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.configuration_sets
    ADD CONSTRAINT configuration_sets_name_key UNIQUE (name);


--
-- Name: configuration_sets configuration_sets_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.configuration_sets
    ADD CONSTRAINT configuration_sets_pkey PRIMARY KEY (id);
...
--
-- Name: algorithms strategies_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: strategy_instances unique_strategy_config; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.strategy_instances
    ADD CONSTRAINT unique_strategy_config UNIQUE (algorithm_id, config_set_id);
...
--
-- Name: idx_candles_1s_target_trend; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_candles_predicted_value_not_null; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_config_sets_active; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_config_sets_active ON public.configuration_sets USING btree (is_active) WHERE (is_active = true);


--
-- Name: idx_config_sets_created_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_config_sets_created_at ON public.configuration_sets USING btree (created_at DESC);
...
CREATE INDEX idx_strategies_mode ON public.algorithms USING btree (mode);
...
CREATE UNIQUE INDEX idx_strategies_name ON public.algorithms USING btree (name);
...
CREATE INDEX idx_strategies_status ON public.algorithms USING btree (status);
...
--
-- Name: idx_strategy_instances_config; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_strategy_instances_config ON public.strategy_instances USING btree (config_set_id);
...
--
-- Name: idx_strategy_instances_strategy; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_strategy_instances_strategy ON public.strategy_instances USING btree (algorithm_id);
...
--
-- Name: configuration_sets trigger_config_sets_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_config_sets_updated_at BEFORE UPDATE ON public.configuration_sets FOR EACH ROW EXECUTE FUNCTION public.update_config_set_updated_at();


--
-- Name: strategy_instances trigger_strategy_instances_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_strategy_instances_updated_at BEFORE UPDATE ON public.strategy_instances FOR EACH ROW EXECUTE FUNCTION public.update_strategy_instance_updated_at();
...
ALTER TABLE ONLY public.strategy_events
    ADD CONSTRAINT strategy_events_strategy_id_fkey FOREIGN KEY (strategy_id) REFERENCES public.algorithms(id) ON DELETE CASCADE;
...
--
-- Name: strategy_instances strategy_instances_config_set_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.strategy_instances
    ADD CONSTRAINT strategy_instances_config_set_id_fkey FOREIGN KEY (config_set_id) REFERENCES public.configuration_sets(id) ON DELETE CASCADE;


--
-- Name: strategy_instances strategy_instances_strategy_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.strategy_instances
    ADD CONSTRAINT strategy_instances_strategy_id_fkey FOREIGN KEY (algorithm_id) REFERENCES public.algorithms(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.strategy_runs
    ADD CONSTRAINT strategy_runs_strategy_id_fkey FOREIGN KEY (strategy_id) REFERENCES public.algorithms(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.strategy_versions
    ADD CONSTRAINT strategy_versions_strategy_id_fkey FOREIGN KEY (strategy_id) REFERENCES public.algorithms(id) ON DELETE CASCADE;
