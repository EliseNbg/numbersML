...
class TestStrategyWorkflow:
    ...
    async def test_complete_strategy_workflow(self, client, db_pool):
        ...
        response = await client.post(f"/api/v1/strategies/{strategy_id}/validate", json={})
        ...
        print("  ✓ Strategy activated in paper mode")
        ...
        response = await client.post("/api/v1/strategies/backtest", json=backtest_request)
        ...
        response = await client.post(f"/api/v1/strategies/{strategy_id}/deactivate", json={})
    ...
    async def test_emergency_stop_workflow(self, client, db_pool):
        ...
        # Activate
        response = await client.post(
            f"/api/v1/strategies/{strategy_id}/activate", json={"mode": "paper"}
        )
        assert response.status_code == 200
