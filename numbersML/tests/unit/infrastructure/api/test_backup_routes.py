...
from src.infrastructure.api.routes.backup import router as backup_router, get_backup_service
...
class TestBackupRoutes:
    ...
    def test_create_backup(self, client_with_mock: TestClient, mock_backup_service: AsyncMock) -> None:
    ...
    def test_create_backup_with_compress(self, client_with_mock: TestClient, mock_backup_service: AsyncMock) -> None:
    ...
    def test_list_backups(self, client_with_mock: TestClient, mock_backup_service: AsyncMock) -> None:
    ...
    def test_get_backup_details(self, client_with_mock: TestClient, mock_backup_service: AsyncMock) -> None:
    ...
    def test_get_backup_details_not_found(self, client_with_mock: TestClient, mock_backup_service: AsyncMock) -> None:
    ...
    def test_restore_backup(self, client_with_mock: TestClient, mock_backup_service: AsyncMock) -> None:
    ...
    def test_restore_backup_not_found(self, client_with_mock: TestClient, mock_backup_service: AsyncMock) -> None:
