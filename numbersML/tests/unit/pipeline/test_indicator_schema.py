...
class TestIndicatorSchema:
    ...
    @pytest.mark.asyncio
    async def test_load_indicator_schema_multi_output_indicators(
    ...
    @pytest.mark.asyncio
    async def test_generate_vector_size_with_multi_output_indicators(
        self, mock_db_pool: MagicMock
    ) -> None:
        ...
        service._last_known = {
            "BTC/USDC": {
                ...
                "volume": 1000.0,
                "atr_14": 100.0,
                "bb_20_2_lower": 49000.0,
                "bb_20_2_middle": 50000.0,
                "bb_20_2_std": 50.0,
                "bb_20_2_upper": 51000.0,
                "macd_12_26_9_macd": -50.0,
                "macd_12_26_9_signal": -40.0,
                "macd_12_26_9_histogram": -10.0,
                "rsi_14": 0.5,
                "sma_20": 49500.0,
            },
            "ETH/USDC": {
                ...
                "volume": 5000.0,
                "atr_14": 50.0,
                "bb_20_2_lower": 2950.0,
                "bb_20_2_middle": 3000.0,
                "bb_20_2_std": 25.0,
                "bb_20_2_upper": 3050.0,
                "macd_12_26_9_macd": -20.0,
                "macd_12_26_9_signal": -15.0,
                "macd_12_26_9_histogram": -5.0,
                "rsi_14": 0.6,
                "sma_20": 2980.0,
            },
        }
    ...
    async def test_load_indicator_schema_active_definitions(self, mock_db_pool: MagicMock) -> None:
        ...
        mock_conn.fetch = AsyncMock(
            return_value=[
                {"name": "atr_14", "class_name": "ATRIndicator", "params": '{"period": 14}'},
