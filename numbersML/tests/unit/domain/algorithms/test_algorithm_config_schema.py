"""Unit tests for algorithm config schema validation."""

from src.domain.algorithms.config_schema import validate_algorithm_config


class TestAlgorithmConfigSchema:
    """Test schema and business validation for algorithm configs."""
