...
class TestStrategyInstanceLifecycle:
    ...
    def test_create_and_list_instances(
        ...
        mock_repo.get_by_strategy_and_config = AsyncMock(return_value=None)

        # Mock saved instance
        mock_instance = MagicMock()
        mock_instance.id = UUID("323e4567-e89b-12d3-a456-426614174002")
        mock_instance.strategy_id = UUID(strategy_instance_payload["strategy_id"])
        ...
        list_resp = client.get("/api/strategy-instances", headers=read_headers)
    ...
    def test_stop_instance(self, client, mock_repo, trader_headers):
        ...
        stop_resp = client.post(
            f"/api/strategy-instances/{instance_id}/stop", headers=trader_headers
        )
    ...
    def test_pause_instance(self, client, mock_repo, trader_headers):
        ...
        pause_resp = client.post(
            f"/api/strategy-instances/{instance_id}/pause", headers=trader_headers
        )
    ...
    def test_resume_instance(self, client, mock_repo, trader_headers):
        ...
        resume_resp = client.post(
            f"/api/strategy-instances/{instance_id}/resume", headers=trader_headers
        )
    ...
    def test_delete_instance(self, client, mock_repo, trader_headers):
        ...
        delete_resp = client.delete(
            f"/api/strategy-instances/{instance_id}", headers=trader_headers
        )
