...
### 1. `src/domain/strategies/strategy_instance.py`
...
### 2. `tests/unit/domain/strategies/test_strategy_instance.py`
...
1. Create `src/domain/strategies/strategy_instance.py` with:
   ...
   - Properties: strategy_id, config_set_id, status, runtime_stats, started_at, stopped_at
   ...
   - Validation in __init__: strategy_id and config_set_id cannot be None

2. Create `tests/unit/domain/strategies/test_strategy_instance.py` with TDD:
...
1. StrategyInstance can be created with valid strategy_id and config_set_id
...
```bash
# Format and lint
black src/domain/strategies/strategy_instance.py tests/unit/domain/strategies/test_strategy_instance.py
ruff check src/domain/strategies/strategy_instance.py tests/unit/domain/strategies/test_strategy_instance.py
mypy src/domain/strategies/strategy_instance.py

# Run tests
.venv/bin/python -m pytest tests/unit/domain/strategies/test_strategy_instance.py -v
```
