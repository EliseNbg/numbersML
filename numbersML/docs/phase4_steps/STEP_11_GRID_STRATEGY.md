...
### 1. `src/domain/strategies/grid_strategy.py`#
...
### 2. `tests/unit/domain/strategies/test_grid_strategy.py`#
...
class TestGridAlgorithmInit:
    ...
    def test_initial_grid_empty(self, grid_strategy):
        """Test that grid levels are empty initially."""
        assert len(grid_strategy.get_grid_levels()) == 0
...
class TestGridInitialization:
    ...
    def test_initialize_grid(self, grid_strategy):
    ...
    def test_grid_levels_count(self, grid_strategy):
        """Test that correct number of levels are created."""
        grid_strategy.set_config("grid_levels", 3)
    ...
    def test_grid_rebalance(self, grid_strategy):
        ...
        grid_strategy.on_tick(tick1)
        old_levels = grid_strategy.get_grid_levels().copy()
        ...
        grid_strategy.on_tick(tick2)
        
        new_levels = grid_strategy.get_grid_levels()
...
class TestBuySignals:
    ...
    def test_buy_signal_near_grid(self, grid_strategy, create_tick):
        ...
        signal = grid_strategy.on_tick(tick2)
    ...
    def test_no_buy_with_position(self, grid_strategy, create_tick):
...
class TestSellSignals:
    ...
    def test_sell_at_take_profit(self, grid_strategy, create_tick):
    ...
    def test_sell_at_stop_loss(self, grid_strategy, create_tick):
...
class TestGridStats:
    ...
    def test_get_grid_stats(self, grid_strategy, create_tick):
...
```bash
# Format and lint
black src/domain/strategies/grid_strategy.py tests/unit/domain/strategies/test_grid_strategy.py
ruff check src/domain/strategies/grid_strategy.py tests/unit/domain/strategies/test_grid_strategy.py
mypy src/domain/strategies/grid_strategy.py

# Run tests
.venv/bin/python -m pytest tests/unit/domain/strategies/test_grid_strategy.py -v
```
